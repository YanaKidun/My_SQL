...
/* Âëîæåííûé çàïğîñ: ïîëüçîâàòåëü, êîòîğûé îñòàâèë ìàêñ êîë-âî reviews*/
SELECT *FROM rewievs r;
...
/* Ïğåäñòàâëåíèå äëÿ ğéòèíãà ïî êíèãàì*/
...
/*òğèããåğ íà äîáâëåíèå îøèáêè â çàêàç, åñëè êîë-âî ìåíüøå 1 øò*/
...
/*âûâîä ğåêîìåíäàöèé êíèã ïî æàíğàì*/
